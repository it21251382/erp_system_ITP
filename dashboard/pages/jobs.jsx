          ...
          <div className="w-full m-auto p-4 border rounded-lg bg-white overflow-y-auto">
            <div className="w-full m-auto p-4 border rounded-lg bg-white overflow-y-auto">
              <div className="my-3 p-2 grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer">
                ...
                <span className="sm:text-left text-right font-bold">Error Type</span>
                <span className="hidden md:grid font-bold">Date</span>
                <span className="hidden sm:grid font-bold">Error description</span>
              </div>
              <ul>
                {data.map((job, id) => (
                  <li
